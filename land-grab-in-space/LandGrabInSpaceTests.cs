...
public class LandGrabInSpaceTests
{
    ...
    public void IsClaimed_yes()
    {
        ...
        ch.StakeClaim(
            CreatePlot(new Coord(1, 1), new Coord(2, 1), new Coord(1, 2), new Coord(2, 2))
        );
        var claimed = ch.IsClaimStaked(
            CreatePlot(new Coord(1, 1), new Coord(2, 1), new Coord(1, 2), new Coord(2, 2))
        );
        Assert.True(claimed);
    }
    ...
    public void IsClaimed_no()
    {
        ...
        var claimed = ch.IsClaimStaked(
            CreatePlot(new Coord(1, 0), new Coord(2, 1), new Coord(1, 2), new Coord(2, 2))
        );
    ...
    public void IsLastClaim_yes()
    {
        ...
        ch.StakeClaim(
            CreatePlot(new Coord(10, 1), new Coord(20, 1), new Coord(10, 2), new Coord(20, 2))
        );
        var lastClaim = ch.IsLastClaim(
            CreatePlot(new Coord(10, 1), new Coord(20, 1), new Coord(10, 2), new Coord(20, 2))
        );
    ...
    private Plot CreatePlot(Coord coord1, Coord coord2, Coord coord3, Coord coord4)
    {
        ...
        else
        {
            throw new InvalidOperationException(
                "You need to implement a constructor for the struct Plot.  The constructor must take 4 co-ordinates.  No such constructor can be found."
            );
        }
    }
}
