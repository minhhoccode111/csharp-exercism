...
public class HyperOptimizedTelemetryTests
{
    ...
    public void FromBuffer_upper_long()
    {
        Assert.Equal(
            Int64.MaxValue,
            TelemetryBuffer.FromBuffer(
                new byte[] { 0xf8, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f }
            )
        );
    }
    ...
    public void FromBuffer_upper_uint()
    {
        Assert.Equal(
            UInt32.MaxValue,
            TelemetryBuffer.FromBuffer(
                new byte[] { 0x4, 0xff, 0xff, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0 }
            )
        );
    }
    ...
    public void FromBuffer_upper_short()
    {
        Assert.Equal(
            Int16.MaxValue,
            TelemetryBuffer.FromBuffer(
                new byte[] { 0xfe, 0xff, 0x7f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 }
            )
        );
    }
    ...
    public void FromBuffer_upper_neg_short()
    {
        Assert.Equal(
            -1,
            TelemetryBuffer.FromBuffer(
                new byte[] { 0xfe, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 }
            )
        );
    }
    ...
    public void FromBuffer_upper_neg_int()
    {
        Assert.Equal(
            Int16.MinValue - 1,
            TelemetryBuffer.FromBuffer(
                new byte[] { 0xfc, 0xff, 0x7f, 0xff, 0xff, 0x0, 0x0, 0x0, 0x0 }
            )
        );
    }
    ...
    public void FromBuffer_upper_neg_long()
    {
        Assert.Equal(
            ...
            TelemetryBuffer.FromBuffer(
                new byte[] { 0xf8, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff, 0xff }
            )
        );
    }
