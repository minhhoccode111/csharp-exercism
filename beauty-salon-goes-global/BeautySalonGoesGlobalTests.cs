...
public class BeautySalonGoesGlobalTests
{
    ...
    {
        Assert.Equal(
            new DateTime(2019, 07, 25, 12, 45, 0),
    ...
    {
        Assert.Equal(
            new DateTime(2019, 07, 24, 16, 0, 0),
            Appointment.GetAlertTime(new DateTime(2019, 7, 25, 16, 0, 0), AlertLevel.Early)
        );
    }
    ...
    {
        Assert.Equal(
            new DateTime(2019, 07, 25, 14, 15, 0),
    ...
    {
        Assert.Equal(
            new DateTime(2019, 07, 25, 15, 30, 0),
            Appointment.GetAlertTime(new DateTime(2019, 7, 25, 16, 0, 0), AlertLevel.Late)
        );
    }
    ...
    {
        Assert.True(
            Appointment.HasDaylightSavingChanged(
                new DateTime(2019, 3, 13, 0, 0, 0),
                Location.NewYork
            )
        );
    }
    ...
    {
        Assert.True(
            Appointment.HasDaylightSavingChanged(new DateTime(2019, 4, 1, 0, 0, 0), Location.London)
        );
    }
    ...
    {
        Assert.True(
            Appointment.HasDaylightSavingChanged(new DateTime(2019, 4, 1, 0, 0, 0), Location.Paris)
        );
    }
    ...
    {
        Assert.Equal(
            new DateTime(2019, 11, 25, 13, 45, 0),
            Appointment.NormalizeDateTime("11/25/2019 13:45:00", Location.NewYork)
        );
    }
    ...
    public void NormalizeDateTime_paris()
    {
        Assert.Equal(
            new DateTime(2019, 11, 25, 13, 45, 0),
            Appointment.NormalizeDateTime("25/11/2019 13:45:00", Location.Paris)
        );
    }
