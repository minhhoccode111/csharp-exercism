...
public class AttackOfTheTrollsTests
{
    ...
    public void Grant_delete_to_read_and_write()
    {
        Assert.Equal(
            Permission.All,
            Permissions.Grant(Permission.Read | Permission.Write, Permission.Delete)
        );
    }
    ...
    public void Grant_read_and_write_to_none()
    {
        Assert.Equal(
            ...
            Permissions.Grant(Permission.None, Permission.Read | Permission.Write)
        );
    }
    ...
    public void Revoke_delete_from_all()
    {
        Assert.Equal(
            Permission.Read | Permission.Write,
            Permissions.Revoke(Permission.All, Permission.Delete)
        );
    }
    ...
    public void Revoke_all_from_read_and_write()
    {
        Assert.Equal(
            Permission.None,
            Permissions.Revoke(Permission.Read | Permission.Write, Permission.All)
        );
    }
